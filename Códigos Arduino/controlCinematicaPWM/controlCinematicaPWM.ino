...
int baseSpeed = 255; // Velocidad base de los motores
...
void setup() {
  ...
  float x = 0, y = 0, z =5; // Posición objetivo
...
void loop() {
  ...
  for (int i = 0; i < Nsensores; i++) {
    ...
    // Calcular velocidad proporcional a la distancia
    int motorSpeed = (distanciaError[i] / maxDistancia) * baseSpeed;
